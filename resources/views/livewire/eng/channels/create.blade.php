            ...
            <div class="flex bg-gray-200 items-center justify-center  mt-6 mb-6">
                <div class="grid bg-white rounded-lg shadow-xl w-full">
                    <div class="flex justify-center">
                        <div class="flex">
                            <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Add New Channel</h1>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        ...
                        <input
                            ...
                            type="text" placeholder="Channel Name" wire:model="name" />
                        @error('name')
                    ...
                    <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                        ...
                        <button wire:click.prevent="ChannelStore()"
