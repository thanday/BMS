    ...
    <div class="bg-gray-800 pt-3">
        <div class="rounded-tl-3xl bg-gradient-to-r from-blue-800 to-gray-800 p-4 shadow text-2xl text-white">
            <h3 class="font-bold pl-2"><span class="text-gray-300 hover:text-gray-50"><a
                        href="{{ route('eng.events') }}">Events</a> </span> | Edit Event</h3>
        </div>
    </div>
                    ...
                    <div class="relative flex flex-col px-4 min-w-0 break-words w-full mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-6 mt-4 mb-4 sm:grid-cols-3">
                            <div>
                                ...
                                <input id="event_name" type="text" wire:model="state.event_name" value="{{ $event->event_name }}"
                            ...
                            <div>
                                ...
                                <input id="refnum" type="text" wire:model="state.refnum" value="{{ $event->refnum }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('refnum')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input id="venue" type="text" wire:model="state.venue" value="{{ $event->venue }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('venue')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <select id="type" wire:model="state.type" name="type" value="{{ $event->type }}"
                            ...
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="type">Service Qouted
                                    Under</label>
                                <select id="qouted_type" wire:model="state.qouted_type" name="type" value="{{ $event->qouted_type }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring appearance-none">
                                    <option>Choose option...</option>
                            ...
                            <div>
                                ...
                                <input id="client" type="text" wire:model="state.client" name="client" value="{{ $event->client }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('client')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input id="focalname" type="text" wire:model="state.focalname" name="focalname" value="{{ $event->focalname }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('client')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="focalnum">Focal Point
                                    Contact</label>
                                <input id="focalnum" type="num" wire:model="state.focalnum" name="focalnum" value="{{ $event->focalnum }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('focalnum')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input id="requestdate" type="date" wire:model="state.requestdate" name="requestdate" value="{{ $event->requestdate }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('requestdate')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="event_date">Live Schedule
                                    Date</label>
                                <input id="event_date" type="date" wire:model="state.event_date" name="event_date" value="{{ $event->event_date }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('event_date')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input id="event_stime" type="time" wire:model="state.event_stime" name="event_stime" value="{{ $event->event_stime }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('event_stime')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input id="event_etime" type="time" wire:model="state.event_etime" name="event_etime" value="{{ $event->event_etime }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                @error('event_etime')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid grid-cols-2 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select wire:model.deffer="state.channels_id" name="channels_id[]"  
                            ...
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="type">Local Channels Feed
                                    Qouted Under</label>
                                <select wire:model="state.local_qtype" name="local_qtype"  value="{{ $event->local_qtype }}"
                                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring appearance-none">
                        ...
                        <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                            ...
                            <button wire:click.prevent="EventUpdate()"
